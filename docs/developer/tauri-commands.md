...
| `cleanupOrphanedProcesses` | none                                                   | `Result<number, string>`                  | Kill stale session children (runtime-contract §11); skips the live session's                                                     |
...
| `stopProject`              | none                                                   | `Result<null, string>`                    | Graceful session stop (runtime-contract §11)                                                                                     |
