...
平台惯例是 `6868`（performer）/ `6869`（monitor）——模板、官方工程与内置工具均使用这对端口；换用其他端口时避开系统保留端口（`1..=1023`）、macOS 临时端口范围（`49152..=65535`）与常见服务端口（AirPlay `5000`/`7000`、开发服务器 `3000`/`5173`/`8000`/`8080`、数据库 `3306`/`5432`/`6379`）。端口选择的完整建议见 [`PNDS_CREATOR_GUIDE.md`](./PNDS_CREATOR_GUIDE.md)。
