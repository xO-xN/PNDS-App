 ...
 * or opening a new folder — after trust (§4) and preflight (§5), the
    ...
    <div className="flex min-h-full flex-col items-center justify-center gap-6 bg-[#d9d9d9] p-8">
      ...
      <p className="mt-16 max-w-2xl text-center text-[15px] leading-8 text-black/80">
        ...
        <button
          ...
          className="mx-1 inline-flex translate-y-[-1px] items-center gap-1 rounded-full border border-black/60 px-2.5 py-0.5 align-baseline text-[12px] text-black hover:bg-black/5 disabled:opacity-50"
        >
          <Plus size={12} />
          {t('sidebar.open')}
        </button>
